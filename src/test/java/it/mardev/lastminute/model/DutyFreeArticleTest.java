...
class DutyFreeArticleTest {
	...
	void given_generic_dutyfree__article_not_imported_get_standard_duty_rate_of_0() {
		...
		assertEquals(0f, article.getTaxRate(), "Standard duty rate should be 10%");
	}
	...
	void given_generic_dutyfree_article_imported_get_standard_duty_rate_of_5() {
		...
		assertEquals(5f, article.getTaxRate(), "Standard duty rate for Imported should be 15%");
	}

	@Test
	void given_generic_dutyfree_article_not_imported_with_sales_price_of_10_get_sales_tax_of_0() {
		DutyFreeArticle article = new DutyFreeArticle(1, "generic", 10, false);
		assertEquals(0f, article.getSalesTax(), "Standard Sales Tax should be 0€");
	}

	@Test
	void given_generic_dutyfree_article_imported_with_sales_price_of_21_get_sales_tax_of_1_05() {
		DutyFreeArticle article = new DutyFreeArticle(1, "generic", 21, true);
		assertEquals(1.05f, article.getSalesTax(), "Standard Sales Tax for Imported should be 1_05€");
	}
